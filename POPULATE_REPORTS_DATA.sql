-- =====================================================
-- POPULATE REPORTS DATA - GUARANTEED TO WORK
-- =====================================================
...
-- Check reports_test_data (if it exists)
DO $$
BEGIN
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'reports_test_data') THEN
        PERFORM 'reports_test_data exists';
    ELSE
        RAISE NOTICE 'reports_test_data does not exist, will create it';
    END IF;
END $$;
...
-- =====================================================
-- STEP 3: UPDATE REPORTS_DATA_VIEW
-- =====================================================
...
3. You should see 8 records in each table
